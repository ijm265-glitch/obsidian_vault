...
연습이 완벽을 만든다 > 연습하면, 스킬이 늠 > 중학교 때 미술 
반복적 연습으로 알려진 유명 예술가들 


**When solving difficult problems, talking with other people is helpful**
도움된다 > 대화하면, 신선하고 다양한 관점 > 문제 해결에 도움
창의성 측면 > 대학교 때
...
커뮤 > 명확한 목표 설명 > 효율적 목표 달성 > 생산성 증가
팀원이 힘들 때 > 해결책 찾는 도움을 줌



**Do you think it is more effective to set several small goals or to set one large goal when working on a project?**
작은 목표 > 달성하기 쉬움 > 동기부여됨 > 높은 생산성
작은 목표 > 쉽게 큰 목표 달성 가능 


**학교 자판기 설치?**
**직원 자판기 설치?**
환경에 더 만족 > 일에 더 집중 > 생산성 증가
시간을 아낄 수 있음 > 효율성에 강점


**실용성 교육 (요리, 청소, 집안일, 등등)<-> 아카데믹 교육**
재미있음 > 스트레스감소 > 공부에 더 집중 > 효율성 증가
여러가지 경험해봐야 함 > 내가 초등학교 컴퓨터

**행복 <-> 돈**
돈에 집착 > 여유 시간이 없음 > 공허함과 번아웃
행복 > 행복하려고 돈 버는거임 > 아니라면 우선순위를 다시 생각
...
**혼자 <-> 같이**
내향적 - 효율이 더 좋음
다같이 방해임 - 혼자하면 집중 가능- 생산성

외향적 - 효율이 더 좋음
다양한 관점 - 문제 해결에 도움
강점에 따른 업무 분담 가능 - 빠르게 목표 도달
